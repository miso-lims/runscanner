...
/**
 * Attempts to process run directories, provided on the command line, through a particular
 * defaultprocessors and display the results. This is for debugging purposes.
 */
public final class ProcessRun {
  ...
  public static void main(String[] args) throws IOException {
    if (args.length == 0) {
      System.err.println(
          "Usage: java -DplatformType=ILLUMINA -Dname=default -Dtz=America/Toronto -Dparameters={} ca.on.oicr.gsi.runscanner.server.ProcessRun /path/to/run/folder");
    }
